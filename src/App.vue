        ...
        <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
            <div class="row">
                <div class="navbar col-4">
                    <img src="./assets/pro04.jpg" class="rounded mx-auto d-block" width="80px" />
                </div>
                <div class="navbar col text-left">
                    <span class="navbar-brand">IT<br />Products</span>
                </div>
            </div>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <router-link class="nav-link" to="/">Products <span class="sr-only">(current)</span></router-link> |
                </li>
